...
import { Editor, type EditorTheme, Text, type TUI, truncateToWidth } from "@mariozechner/pi-tui";
...
function setSingleAnswer(answerState: AnswerState, answer: string, custom = ""): void {
